...
declare module "@salesforce/schema/Contact.CORE_B_EmailPermission__c" {
  const CORE_B_EmailPermission__c:boolean;
  export default CORE_B_EmailPermission__c;
}
declare module "@salesforce/schema/Contact.CORE_B_MailPermission__c" {
  const CORE_B_MailPermission__c:boolean;
  export default CORE_B_MailPermission__c;
}
declare module "@salesforce/schema/Contact.CORE_B_PhonePermission__c" {
  const CORE_B_PhonePermission__c:boolean;
  export default CORE_B_PhonePermission__c;
}
declare module "@salesforce/schema/Contact.CORE_B_PrivateAccount__c" {
  const CORE_B_PrivateAccount__c:boolean;
  export default CORE_B_PrivateAccount__c;
}
declare module "@salesforce/schema/Contact.CORE_B_RobinsonList__c" {
  const CORE_B_RobinsonList__c:boolean;
  export default CORE_B_RobinsonList__c;
}
declare module "@salesforce/schema/Contact.CORE_B_SMSPermission__c" {
  const CORE_B_SMSPermission__c:boolean;
  export default CORE_B_SMSPermission__c;
}
declare module "@salesforce/schema/Contact.CORE_P_IdentityType__c" {
  const CORE_P_IdentityType__c:string;
  export default CORE_P_IdentityType__c;
}
declare module "@salesforce/schema/Contact.CORE_T_Identity__c" {
  const CORE_T_Identity__c:string;
  export default CORE_T_Identity__c;
}
declare module "@salesforce/schema/Contact.CORE_T_InternalCode__c" {
  const CORE_T_InternalCode__c:string;
  export default CORE_T_InternalCode__c;
}
