...
declare module "@salesforce/schema/Task.COMM_P_Origen__c" {
  const COMM_P_Origen__c:string;
  export default COMM_P_Origen__c;
}
declare module "@salesforce/schema/Task.COMM_F_Owner__c" {
  const COMM_F_Owner__c:string;
  export default COMM_F_Owner__c;
}
declare module "@salesforce/schema/Task.COMM_C_Mifid__c" {
  const COMM_C_Mifid__c:boolean;
  export default COMM_C_Mifid__c;
}
declare module "@salesforce/schema/Task.COMM_P_Product__c" {
  const COMM_P_Product__c:string;
  export default COMM_P_Product__c;
}
declare module "@salesforce/schema/Task.COMM_P_EventPriority__c" {
  const COMM_P_EventPriority__c:string;
  export default COMM_P_EventPriority__c;
}
