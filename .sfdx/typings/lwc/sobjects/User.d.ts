...
declare module "@salesforce/schema/User.Suffix" {
  const Suffix:string;
...
declare module "@salesforce/schema/User.CORE_T_Office__c" {
  const CORE_T_Office__c:string;
  export default CORE_T_Office__c;
}
declare module "@salesforce/schema/User.CORE_T_EmployeeCode__c" {
  const CORE_T_EmployeeCode__c:string;
  export default CORE_T_EmployeeCode__c;
}
